...
func (a *GroupsApi) CreateGroupExecute(r ApiCreateGroupRequest) (*Group, *http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "GroupsApi.CreateGroup")
	if err != nil {
...
func (a *GroupsApi) DeleteGroupExecute(r ApiDeleteGroupRequest) (*http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "GroupsApi.DeleteGroup")
	if err != nil {
...
func (a *GroupsApi) GetGroupExecute(r ApiGetGroupRequest) (*Group, *http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "GroupsApi.GetGroup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *GroupsApi) GetGroupsExecute(r ApiGetGroupsRequest) (*GroupCollection, *http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "GroupsApi.GetGroups")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *GroupsApi) UpdateGroupExecute(r ApiUpdateGroupRequest) (*Group, *http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "GroupsApi.UpdateGroup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
