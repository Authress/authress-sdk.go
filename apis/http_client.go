...
func (c *HttpClient) callAPI(request *http.Request) (*http.Response, error) {
	if c.ClientConfiguration.Debug {
	...
	resp, err := c.InternalClient.Do(request)
	if err != nil {
		return resp, err
	}
...
func (c *HttpClient) prepareRequest(
	...
	if c.ClientConfiguration.Host != "" {
		url.Host = c.ClientConfiguration.Host
	}

	// Override request scheme, if applicable
	if c.ClientConfiguration.Scheme != "" {
		url.Scheme = c.ClientConfiguration.Scheme
	}
	...
	for header, value := range c.ClientConfiguration.DefaultHeader {
