...
func (a *ExtensionsApi) CreateExtensionExecute(r ApiCreateExtensionRequest) (*Extension, *http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "ExtensionsApi.CreateExtension")
	if err != nil {
...
func (a *ExtensionsApi) DeleteExtensionExecute(r ApiDeleteExtensionRequest) (*http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "ExtensionsApi.DeleteExtension")
	if err != nil {
...
func (a *ExtensionsApi) GetExtensionExecute(r ApiGetExtensionRequest) (*Extension, *http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "ExtensionsApi.GetExtension")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *ExtensionsApi) GetExtensionsExecute(r ApiGetExtensionsRequest) (*ExtensionCollection, *http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "ExtensionsApi.GetExtensions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *ExtensionsApi) LoginExecute(r ApiLoginRequest) (*OAuthAuthorizeResponse, *http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "ExtensionsApi.Login")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *ExtensionsApi) RequestTokenExecute(r ApiRequestTokenRequest) (*OAuthTokenResponse, *http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "ExtensionsApi.RequestToken")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *ExtensionsApi) UpdateExtensionExecute(r ApiUpdateExtensionRequest) (*Extension, *http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "ExtensionsApi.UpdateExtension")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
