...
func (a *ServiceClientsApi) CreateClientExecute(r ApiCreateClientRequest) (*Client, *http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "ServiceClientsApi.CreateClient")
	if err != nil {
...
func (a *ServiceClientsApi) DeleteAccessKeyExecute(r ApiDeleteAccessKeyRequest) (*http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "ServiceClientsApi.DeleteAccessKey")
	if err != nil {
...
func (a *ServiceClientsApi) DeleteClientExecute(r ApiDeleteClientRequest) (*http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "ServiceClientsApi.DeleteClient")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *ServiceClientsApi) GetClientExecute(r ApiGetClientRequest) (*Client, *http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "ServiceClientsApi.GetClient")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *ServiceClientsApi) GetClientsExecute(r ApiGetClientsRequest) (*ClientCollection, *http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "ServiceClientsApi.GetClients")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *ServiceClientsApi) RequestAccessKeyExecute(r ApiRequestAccessKeyRequest) (*ClientAccessKey, *http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "ServiceClientsApi.RequestAccessKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *ServiceClientsApi) UpdateClientExecute(r ApiUpdateClientRequest) (*Client, *http.Response, error) {
	...
	localBasePath, err := a.Client.ClientConfiguration.ServerURLWithContext(r.ctx, "ServiceClientsApi.UpdateClient")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
