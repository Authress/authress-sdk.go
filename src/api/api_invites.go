...
func (a *InvitesApi) CreateInviteExecute(r ApiCreateInviteRequest) (*Invite, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InvitesApi.CreateInvite")
	if err != nil {
...
func (a *InvitesApi) DeleteInviteExecute(r ApiDeleteInviteRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InvitesApi.DeleteInvite")
	if err != nil {
...
func (a *InvitesApi) GetInviteExecute(r ApiGetInviteRequest) (*Invite, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InvitesApi.GetInvite")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *InvitesApi) RespondToInviteExecute(r ApiRespondToInviteRequest) (*Account, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InvitesApi.RespondToInvite")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
