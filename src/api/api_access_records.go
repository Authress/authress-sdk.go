...
// AccessRecordsAPIService AccessRecordsAPI service
type AccessRecordsAPIService service

type ApiCreateClaimRequest struct {
	ctx context.Context
	ApiService *AccessRecordsAPIService
...
*/
func (a *AccessRecordsAPIService) CreateClaim(ctx context.Context) ApiCreateClaimRequest {
	return ApiCreateClaimRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AccessRecordsAPIService) CreateClaimExecute(r ApiCreateClaimRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccessRecordsAPIService.CreateClaim")
	if err != nil {
...
*/
func (a *AccessRecordsAPIService) CreateRecord(ctx context.Context) ApiCreateRecordRequest {
	return ApiCreateRecordRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return AccessRecord
func (a *AccessRecordsAPIService) CreateRecordExecute(r ApiCreateRecordRequest) (*AccessRecord, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccessRecordsAPIService.CreateRecord")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *AccessRecordsAPIService) CreateRequest(ctx context.Context) ApiCreateRequestRequest {
	return ApiCreateRequestRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AccessRecordsAPIService) CreateRequestExecute(r ApiCreateRequestRequest) (*AccessRequest, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccessRecordsAPIService.CreateRequest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *AccessRecordsAPIService) DeleteRecord(ctx context.Context, recordId string) ApiDeleteRecordRequest {
	return ApiDeleteRecordRequest{
		ApiService: a,
		ctx: ctx,
		recordId: recordId,
...
// Execute executes the request
func (a *AccessRecordsAPIService) DeleteRecordExecute(r ApiDeleteRecordRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccessRecordsAPIService.DeleteRecord")
	if err != nil {
...
*/
func (a *AccessRecordsAPIService) DeleteRequest(ctx context.Context, requestId string) ApiDeleteRequestRequest {
	return ApiDeleteRequestRequest{
		ApiService: a,
		ctx: ctx,
		requestId: requestId,
...
// Execute executes the request
func (a *AccessRecordsAPIService) DeleteRequestExecute(r ApiDeleteRequestRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccessRecordsAPIService.DeleteRequest")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *AccessRecordsAPIService) GetRecord(ctx context.Context, recordId string) ApiGetRecordRequest {
	return ApiGetRecordRequest{
		ApiService: a,
		ctx: ctx,
		recordId: recordId,
...
// Execute executes the request
//  @return AccessRecord
func (a *AccessRecordsAPIService) GetRecordExecute(r ApiGetRecordRequest) (*AccessRecord, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccessRecordsAPIService.GetRecord")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *AccessRecordsAPIService) GetRecords(ctx context.Context) ApiGetRecordsRequest {
	return ApiGetRecordsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AccessRecordsAPIService) GetRecordsExecute(r ApiGetRecordsRequest) (*AccessRecordCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccessRecordsAPIService.GetRecords")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *AccessRecordsAPIService) GetRequest(ctx context.Context, requestId string) ApiGetRequestRequest {
	return ApiGetRequestRequest{
		ApiService: a,
		ctx: ctx,
		requestId: requestId,
...
// Execute executes the request
//  @return AccessRequest
func (a *AccessRecordsAPIService) GetRequestExecute(r ApiGetRequestRequest) (*AccessRequest, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccessRecordsAPIService.GetRequest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *AccessRecordsAPIService) GetRequests(ctx context.Context) ApiGetRequestsRequest {
	return ApiGetRequestsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AccessRecordsAPIService) GetRequestsExecute(r ApiGetRequestsRequest) (*AccessRequestCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccessRecordsAPIService.GetRequests")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiRespondToAccessRequestRequest) Execute() (*AccessRequest, *http.Response, error) {
	return r.ApiService.RespondToAccessRequestExecute(r)
}
...
*/
func (a *AccessRecordsAPIService) RespondToAccessRequest(ctx context.Context, requestId string) ApiRespondToAccessRequestRequest {
	return ApiRespondToAccessRequestRequest{
		ApiService: a,
		ctx: ctx,
		requestId: requestId,
...
// Execute executes the request
//  @return AccessRequest
func (a *AccessRecordsAPIService) RespondToAccessRequestExecute(r ApiRespondToAccessRequestRequest) (*AccessRequest, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccessRecordsAPIService.RespondToAccessRequest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *AccessRecordsAPIService) UpdateRecord(ctx context.Context, recordId string) ApiUpdateRecordRequest {
	return ApiUpdateRecordRequest{
		ApiService: a,
		ctx: ctx,
		recordId: recordId,
...
// Execute executes the request
func (a *AccessRecordsAPIService) UpdateRecordExecute(r ApiUpdateRecordRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccessRecordsAPIService.UpdateRecord")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
