...
*/
func (a *ExtensionsAPIService) DeleteExtension(ctx context.Context, extensionId string) ApiDeleteExtensionRequest {
	return ApiDeleteExtensionRequest{
		ApiService: a,
		ctx: ctx,
...
*/
func (a *ExtensionsAPIService) GetExtension(ctx context.Context, extensionId string) ApiGetExtensionRequest {
	return ApiGetExtensionRequest{
		ApiService: a,
		ctx: ctx,
		extensionId: extensionId,
...
func (a *ExtensionsAPIService) GetExtensionsExecute(r ApiGetExtensionsRequest) (*ExtensionCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *ExtensionsAPIService) Login(ctx context.Context) ApiLoginRequest {
	return ApiLoginRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ExtensionsAPIService) LoginExecute(r ApiLoginRequest) (*OAuthAuthorizeResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExtensionsAPIService.Login")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ExtensionsAPIService) RequestToken(ctx context.Context) ApiRequestTokenRequest {
	return ApiRequestTokenRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ExtensionsAPIService) RequestTokenExecute(r ApiRequestTokenRequest) (*OAuthTokenResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExtensionsAPIService.RequestToken")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ExtensionsAPIService) UpdateExtension(ctx context.Context, extensionId string) ApiUpdateExtensionRequest {
	return ApiUpdateExtensionRequest{
		ApiService: a,
		ctx: ctx,
		extensionId: extensionId,
...
// Execute executes the request
//  @return Extension
func (a *ExtensionsAPIService) UpdateExtensionExecute(r ApiUpdateExtensionRequest) (*Extension, *http.Response, error) {
	var (
