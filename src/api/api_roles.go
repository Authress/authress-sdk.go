...
func (a *RolesApi) CreateRoleExecute(r ApiCreateRoleRequest) (*Role, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RolesApi.CreateRole")
	if err != nil {
...
func (a *RolesApi) DeleteRoleExecute(r ApiDeleteRoleRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RolesApi.DeleteRole")
	if err != nil {
...
func (a *RolesApi) GetRoleExecute(r ApiGetRoleRequest) (*Role, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RolesApi.GetRole")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *RolesApi) GetRolesExecute(r ApiGetRolesRequest) (*RoleCollection, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RolesApi.GetRoles")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *RolesApi) UpdateRoleExecute(r ApiUpdateRoleRequest) (*Role, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RolesApi.UpdateRole")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
