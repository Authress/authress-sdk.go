...
func (r ApiAuthorizeUserRequest) Execute() (*http.Response, error) {
	return r.ApiService.AuthorizeUserExecute(r)
}
...
*/
func (a *UserPermissionsAPIService) AuthorizeUser(ctx context.Context, userId UserId, resourceUri string, permission Action) ApiAuthorizeUserRequest {
	return ApiAuthorizeUserRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *UserPermissionsAPIService) AuthorizeUserExecute(r ApiAuthorizeUserRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserPermissionsAPIService.AuthorizeUser")
	if err != nil {
...
func (r ApiGetUserPermissionsForResourceRequest) Execute() (*PermissionCollection, *http.Response, error) {
	return r.ApiService.GetUserPermissionsForResourceExecute(r)
}
...
*/
func (a *UserPermissionsAPIService) GetUserPermissionsForResource(ctx context.Context, userId UserId, resourceUri string) ApiGetUserPermissionsForResourceRequest {
	return ApiGetUserPermissionsForResourceRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *UserPermissionsAPIService) GetUserPermissionsForResourceExecute(r ApiGetUserPermissionsForResourceRequest) (*PermissionCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserPermissionsAPIService.GetUserPermissionsForResource")
	if err != nil {
...
*/
func (a *UserPermissionsAPIService) GetUserResources(ctx context.Context, userId UserId) ApiGetUserResourcesRequest {
	return ApiGetUserResourcesRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *UserPermissionsAPIService) GetUserResourcesExecute(r ApiGetUserResourcesRequest) (*UserResourcesCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserPermissionsAPIService.GetUserResources")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetUserRolesForResourceRequest) Execute() (*UserRoleCollection, *http.Response, error) {
	return r.ApiService.GetUserRolesForResourceExecute(r)
}
...
*/
func (a *UserPermissionsAPIService) GetUserRolesForResource(ctx context.Context, userId UserId, resourceUri string) ApiGetUserRolesForResourceRequest {
	return ApiGetUserRolesForResourceRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *UserPermissionsAPIService) GetUserRolesForResourceExecute(r ApiGetUserRolesForResourceRequest) (*UserRoleCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserPermissionsAPIService.GetUserRolesForResource")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
