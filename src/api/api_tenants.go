...
func (a *TenantsApi) CreateTenantExecute(r ApiCreateTenantRequest) (*Tenant, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TenantsApi.CreateTenant")
	if err != nil {
...
func (a *TenantsApi) DeleteTenantExecute(r ApiDeleteTenantRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TenantsApi.DeleteTenant")
	if err != nil {
...
func (a *TenantsApi) GetTenantExecute(r ApiGetTenantRequest) (*Tenant, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TenantsApi.GetTenant")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *TenantsApi) GetTenantsExecute(r ApiGetTenantsRequest) (*TenantCollection, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TenantsApi.GetTenants")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *TenantsApi) UpdateTenantExecute(r ApiUpdateTenantRequest) (*Tenant, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TenantsApi.UpdateTenant")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
