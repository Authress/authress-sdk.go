...
func (a *UsersApi) DeleteUserExecute(r ApiDeleteUserRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersApi.DeleteUser")
	if err != nil {
...
func (a *UsersApi) GetUserExecute(r ApiGetUserRequest) (*UserIdentity, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersApi.GetUser")
	if err != nil {
...
func (a *UsersApi) GetUsersExecute(r ApiGetUsersRequest) (*UserIdentityCollection, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersApi.GetUsers")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
