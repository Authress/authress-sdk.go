...
*/
func (a *GroupsAPIService) DeleteGroup(ctx context.Context, groupId GroupId) ApiDeleteGroupRequest {
	return ApiDeleteGroupRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
*/
func (a *GroupsAPIService) GetGroup(ctx context.Context, groupId GroupId) ApiGetGroupRequest {
	return ApiGetGroupRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
func (a *GroupsAPIService) GetGroupsExecute(r ApiGetGroupsRequest) (*GroupCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *GroupsAPIService) UpdateGroup(ctx context.Context, groupId GroupId) ApiUpdateGroupRequest {
	return ApiUpdateGroupRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
