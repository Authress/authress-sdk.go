...
// ResourcePermissionsAPIService ResourcePermissionsAPI service
type ResourcePermissionsAPIService service

type ApiGetPermissionedResourceRequest struct {
	ctx context.Context
	ApiService *ResourcePermissionsAPIService
	resourceUri string
}

func (r ApiGetPermissionedResourceRequest) Execute() (*PermissionedResource, *http.Response, error) {
	return r.ApiService.GetPermissionedResourceExecute(r)
}
...
*/
func (a *ResourcePermissionsAPIService) GetPermissionedResource(ctx context.Context, resourceUri string) ApiGetPermissionedResourceRequest {
	return ApiGetPermissionedResourceRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *ResourcePermissionsAPIService) GetPermissionedResourceExecute(r ApiGetPermissionedResourceRequest) (*PermissionedResource, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ResourcePermissionsAPIService.GetPermissionedResource")
	if err != nil {
...
func (r ApiGetPermissionedResourcesRequest) Execute() (*PermissionedResourceCollection, *http.Response, error) {
	return r.ApiService.GetPermissionedResourcesExecute(r)
}
...
*/
func (a *ResourcePermissionsAPIService) GetPermissionedResources(ctx context.Context) ApiGetPermissionedResourcesRequest {
	return ApiGetPermissionedResourcesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ResourcePermissionsAPIService) GetPermissionedResourcesExecute(r ApiGetPermissionedResourcesRequest) (*PermissionedResourceCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ResourcePermissionsAPIService.GetPermissionedResources")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ResourcePermissionsAPIService) GetResourceUsers(ctx context.Context, resourceUri string) ApiGetResourceUsersRequest {
	return ApiGetResourceUsersRequest{
		ApiService: a,
		ctx: ctx,
		resourceUri: resourceUri,
...
func (a *ResourcePermissionsAPIService) GetResourceUsersExecute(r ApiGetResourceUsersRequest) (*ResourceUsersCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ResourcePermissionsAPIService.GetResourceUsers")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdatePermissionedResourceRequest) Execute() (*http.Response, error) {
	return r.ApiService.UpdatePermissionedResourceExecute(r)
}
...
*/
func (a *ResourcePermissionsAPIService) UpdatePermissionedResource(ctx context.Context, resourceUri string) ApiUpdatePermissionedResourceRequest {
	return ApiUpdatePermissionedResourceRequest{
		ApiService: a,
		ctx: ctx,
		resourceUri: resourceUri,
...
// Execute executes the request
func (a *ResourcePermissionsAPIService) UpdatePermissionedResourceExecute(r ApiUpdatePermissionedResourceRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ResourcePermissionsAPIService.UpdatePermissionedResource")
	if err != nil {
